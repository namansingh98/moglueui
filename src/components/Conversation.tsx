...
const Conversation: React.FC<ConversationProps> = ({ onClose }) => {
  return (
    <div className="conversation-container relative ">
      <div className="flex justify-end absolute top-1 z-40  right-0  flex-wrap items-center">
        <Button variant={"default"}  className="dark:text-black" onClick={onClose}>
          Close
        </Button>
      </div>
      {/* Place your conversation content here */}
      <div className="flex flex-col items-center justify-center  min-h-screen dark:bg-gray-100 text-gray-800 p-10">
